...
@TypeAlias("questionTheorique")
@Document(collection = "question")
public class QuestionThorique extends Question {
    @NotNull
    ...
    public QuestionThorique(String id, String enonce, String module, int dureeReponse, int niveau, TypeQuestion type, String explications, int pointsMax, int nbEssaisMax, List<String> options, int indiceCorrectOption, Date dateDebut) {
    ...
    public QuestionThorique(List<String> options, int indiceCorrectOption, Date dateDebut) {
        this.options = options;
        this.indiceCorrectOption = indiceCorrectOption;
        DateDebut = dateDebut;
    }
public QuestionThorique(){
        super();
}
